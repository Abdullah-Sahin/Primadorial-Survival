...
public class Game {
    ...
    public static void play(Individual individual){
        while(true){
            ...
            switch (answer) {
                case "1" -> individual.showAllDetails();
                case "2" -> {
                    while (true) {
                        System.out.println("""
                                1. To go Shop
                        ...
                        if (answer.equalsIgnoreCase("q")) {
                            ...
                            switch (answer) {
                                case "1" -> Shop.shopping(individual);
                                case "2" -> {
                                    while(true){
                                    BlackSmith.ask();
                ...
                case "3" -> individual.goOnAdventure();
                case "4" -> individual.wearArmor();
                case "5" -> individual.wearWeapon();
                default -> System.out.println("*****INVALID INPUT*****");
            }
        }
    }
